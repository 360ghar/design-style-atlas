...
| Accent | `#BE4F2B` | Primary actions, highlights |
| Accent 2 | `#4F7793` | Secondary emphasis, badges, special states |

Keep contrast at 4.5:1 minimum for body text. Terracotta #BE4F2B for send, active, and key highlights; slate-blue accent2 for artifacts and citations.
...
Round terracotta send button (44px circle, arrow-up glyph); ghost icon buttons; suggestion chips outlined pill.
