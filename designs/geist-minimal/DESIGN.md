...
| Accent | `#0070F3` | Primary actions, highlights |
| Accent 2 | `#7928CA` | Secondary emphasis, badges, special states |

Keep contrast at 4.5:1 minimum for body text. Blue #0070F3 for primary actions and links; conic-gradient beams for hero moments only.
