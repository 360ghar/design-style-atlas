...
export default function Home() {
  ...
  return (
    <div>
      {/* ---------- Hero ---------- */}
      <section className="border-b border-[#111110]">
        <div className="mx-auto max-w-6xl px-4 pb-10 pt-14 sm:px-6 sm:pt-20">
          <p className="inline-block border border-[#111110] px-2 py-1 font-mono text-[10.5px] uppercase tracking-[0.18em]">
          ...
          <p className="mt-5 max-w-2xl font-serif text-[19px] italic leading-relaxed text-[#111110]/75 sm:text-[21px]">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <a
              href="#catalog"
              className="border border-[#111110] bg-[#111110] px-6 py-3 font-mono text-[12px] font-semibold uppercase tracking-[0.12em] text-white hover:bg-transparent hover:text-[#111110]"
            >
              Browse styles ↓
            </a>
            <a
              ...
              className="border border-[#111110] bg-transparent px-6 py-3 font-mono text-[12px] font-semibold uppercase tracking-[0.12em] hover:bg-[#111110] hover:text-white"
            >
              View on GitHub ↗
            </a>
          </div>
          <dl className="mt-9 grid grid-cols-1 gap-px border border-[#111110]/20 bg-[#111110]/20 sm:grid-cols-3">
            {[
              ["100", "production-ready styles"],
              ["Codex · Claude Code · Cursor", "works with your agent"],
              ["MIT", "open source, forever"],
            ].map(([k, v]) => (
              <div key={k} className="bg-[#fafaf8] px-5 py-4">
                <dt className="font-mono text-[15px] font-semibold">{k}</dt>
                <dd className="mt-0.5 font-mono text-[11px] uppercase tracking-[0.12em] text-[#111110]/55">
                  {v}
                </dd>
              </div>
            ))}
      ...
      {/* ---------- Usage ---------- */}
      <section id="usage" className="scroll-mt-14 border-t border-[#111110]">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-14 sm:px-6 md:grid-cols-2">
          <div>
            ...
            <ol className="mt-6 space-y-4">
              {[
                ...
                <li key={t} className="flex gap-4 border-t border-[#111110]/15 pt-4">
                  <span className="font-mono text-[13px] font-semibold">0{i + 1}</span>
                  <div>
                    <p className="font-semibold">{t}</p>
                    <p className="mt-1 text-sm leading-relaxed text-[#111110]/65">{d}</p>
                  </div>
                </li>
              ))}
            </ol>
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-[#111110]/20 bg-[#111110] p-5">
...
"Follow @DESIGN.md for all UI work."`}
            ...
            <div className="border border-[#111110]/20 bg-white p-5">
              <p className="font-mono text-[10.5px] uppercase tracking-[0.18em] text-[#111110]/50">
                What each file covers
              </p>
              <p className="mt-3 text-sm leading-relaxed text-[#111110]/70">
