    ...
    <Frame meta={meta} large={large}>
      <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column", background: p.bg, color: p.ink, fontFamily: ff, overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", display: "flex", alignItems: "center", gap: large ? 10 : 6, padding: large ? "12px 18px" : "7px 10px" }}>
          ...
          <div style={{ display: "flex", gap: large ? 12 : 7, fontSize: fs.nav, fontWeight: 500, color: p.ink }}>
            <span>Products</span>
          ...
          <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: large ? 10 : 6, fontSize: fs.nav, fontWeight: 500 }}>
            <span>Sign in</span>
            <span style={{ background: p.accent, color: p.bg, borderRadius: 999, padding: large ? "6px 14px" : "3px 9px", fontSize: fs.btn, fontWeight: 600, boxShadow: "0 6px 12px -2px rgba(10,37,64,0.08),0 3px 7px -3px rgba(10,37,64,0.1)" }}>Start now →</span>
          </div>
        </div>
        ...
        {/* partner CTA footer */}
        <div style={{ position: "relative", marginTop: "auto", background: p.surface, borderTop: "1px solid ${p.ink}15", padding: large ? "9px 18px" : "5px 10px", display: "flex", alignItems: "center", gap: large ? 10 : 6 }}>
          ...
          <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: large ? 10 : 6, fontSize: fs.foot, fontWeight: 600 }}>
            ...
            <span style={{ background: p.accent, color: p.bg, borderRadius: 8, padding: large ? "6px 14px" : "3px 9px" }}>Get in touch →</span>
          </div>
        </div>
      </div>
