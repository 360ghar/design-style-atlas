  ...
  return (
    <Frame meta={meta} large={large}>
      ...
      >
        ...
        >
          <span style={{ fontFamily: p.display, fontWeight: 700, fontSize: large ? 18 : 11 }}>
            ✿ Our Album
          </span>
          {(["1998", "2004", "Now"] as const).map((t, i) => (
            <span
              ...
              style={{
                ...
                background: i === 1 ? p.accent : i === 2 ? p.accent2 : p.surface,
                color: i === 0 ? p.ink : p.surface,
        ...
        <div style={{ flex: 1, display: "flex", gap: large ? 14 : 8, padding: `0 ${pad}px`, alignItems: "center", minHeight: 0 }}>
          <div style={{ flex: "1.1", minWidth: 0 }}>
            ...
            <div style={{ fontFamily: p.display, fontWeight: 700, fontSize: fsXl, lineHeight: 1.02, marginTop: large ? 6 : 3 }}>
              Every ticket,
              <br />
              every <span style={{ color: p.accent }}>sun-faded</span> day.
            </div>
            <div style={{ fontSize: fsMd, color: p.muted, marginTop: large ? 6 : 3, lineHeight: 1.4 }}>
              Polaroids, stubs &amp; margin notes — June 12, lake house.
            </div>
          </div>
          <div style={{ flex: 1, display: "flex", justifyContent: "center", gap: large ? 10 : 6 }}>
            {[
              { cap: "— mall, '04", bg: p.accent, glyph: "◍", rot: "-4deg" },
              { cap: "— camp!!", bg: p.accent2, glyph: "✿", rot: "3deg" },
            ].map((c) => (
              <div
                key={c.cap}
                style={{
              ...
              >
                ...
                <div style={{ fontFamily: p.display, fontWeight: 600, fontSize: large ? 13 : 8, marginTop: 3 }}>
                  {c.cap}
                </div>
                <div style={{ fontSize: large ? 8 : 5.5, color: p.muted, letterSpacing: "0.08em" }}>06 · 12 · 04 ★</div>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          ...
          <span style={{ fontSize: fsXs, color: p.muted }}>
            <b style={{ color: p.ink }}>128 pages</b> · print-ready · xoxo, summer →
          </span>
          <span style={{ flex: 1 }} />
          <span
            style={{
