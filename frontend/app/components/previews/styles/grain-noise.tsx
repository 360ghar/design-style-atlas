      ...
      >
        ...
        >
          <div className="flex items-center" style={{ gap: 7 }}>
            <span aria-hidden style={{ width: large ? 10 : 8, height: large ? 10 : 8, borderRadius: "50%", background: p.accent, boxShadow: "0 0 12px rgba(232,255,71,0.55)" }} />
            <span style={{ fontFamily: p.display, fontWeight: 700, fontSize: large ? 11 : 8, letterSpacing: "0.08em" }}>
              GRAIN/STOCK
            </span>
          </div>
          <div style={{ fontFamily: "monospace", fontSize: large ? 8.5 : 6, letterSpacing: "0.1em", color: p.muted }}>
            ISO 400 · f/2.8
          </div>
        </div>
        ...
        <div className="relative flex-1" style={{ padding: `${large ? 12 : 8}px ${pad}px` }}>
          ...
          >
            ...
            <div className="relative">
              <div style={{ fontFamily: "monospace", fontSize: large ? 8 : 5.5, letterSpacing: "0.12em", color: p.accent, fontWeight: 600 }}>
                35MM · FRAME 12A
              </div>
              <div
                style={{
              ...
              <div style={{ fontSize: large ? 9.5 : 6.5, color: p.muted, marginTop: 4 }}>Warm blacks · soft highlights · always grain</div>
              <div className="flex items-center" style={{ gap: 6, marginTop: large ? 10 : 7 }}>
                ...
                <span style={{ fontSize: large ? 9 : 6, color: p.ink, border: "1px solid rgba(237,234,226,0.12)", padding: `${large ? 6 : 4}px ${large ? 11 : 8}px`, borderRadius: 999 }}>
                  View journal →
                </span>
              </div>
            </div>
        ...
        >
          ...
          <span style={{ color: p.accent2 }}>● REC</span>
        </div>
      </div>
